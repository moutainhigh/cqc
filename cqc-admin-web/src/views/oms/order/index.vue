  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="faqTable"
        ...
        <el-table-column label="抢单用户账号" width="200" align="center">
          <template slot-scope="scope">{{scope.row.account}}</template>
        </el-table-column>

        <el-table-column label="抢单人收款姓名" width="200" align="center">
          <template slot-scope="scope">{{scope.row.receiveCodeName}}</template>
        </el-table-column>
